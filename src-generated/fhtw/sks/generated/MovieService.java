 ...
 * 
 */
@WebServiceClient(name = "MovieService", targetNamespace = "http://soap.services.technikumwien.at/", wsdlLocation = "http://localhost:8080/MovieServiceWebApp/MovieService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MOVIESERVICE_QNAME = new QName("http://soap.services.technikumwien.at/", "MovieService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/MovieServiceWebApp/MovieService?wsdl");
    ...
    public MovieWebService getMovieServicePort() {
        return super.getPort(new QName("http://soap.services.technikumwien.at/", "MovieServicePort"), MovieWebService.class);
    }
     ...
     */
    @WebEndpoint(name = "MovieServicePort")
    public MovieWebService getMovieServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.services.technikumwien.at/", "MovieServicePort"), MovieWebService.class, features);
    }
